...
class TestModule(TransactionCase):
    ...
    #     self.assertEqual(
    #         partner.name, self.name_without_separator,
    ...
    #     partner = self.partner_obj.create(vals)
    #     self.assertEqual(
    #         partner.name, self.name_with_separator,
    ...
    #     self.assertEqual(
    #         initial_search, disabled_feature_search,
    ...
    #     self.assertEqual(
    #         ensabled_feature_search_ordered, initial_search + 1,
